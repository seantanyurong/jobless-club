            ...
            <a href='https://www.sharpknifesg.com/' target='_blank'>
              <div className='flex items-center mb-2'>
                ...
                <Image
                  ...
                  className='hidden lg:block mr-4'
                />
                <h3 className='font-black text-base lg:text-3xl'>Knife Sharpening SG</h3>
                <div className='bg-white rounded-full px-1 py-1 pl-5 relative block lg:hidden ml-auto'>
                  <Image
                    src='/images/fire-drawing.png'
                    width={15}
                    ...
                    className='absolute left-2 top-1/2 -translate-y-1/2'
                  />
                  <p className='text-xs font-semibold w-[65px] text-center'>$1,283</p>
                </div>
                <div className='bg-white rounded-full px-2 py-1 pl-12 relative hidden lg:block ml-auto'>
                  <Image
                    src='/images/fire-drawing.png'
                    ...
                    className='absolute left-3 top-1/2 -translate-y-1/2'
                  />
                  <p className='text-sm font-semibold w-[80px] text-center'>$1,283</p>
                </div>
              </div>
              <p className='text-xs lg:text-base'>
              ...
              <div className='flex items-center mb-2'>
                ...
                <div className='bg-white rounded-full px-1 py-1 pl-5 relative block lg:hidden ml-auto'>
                  <Image
                    ...
                    className='absolute left-2 top-1/2 -translate-y-1/2'
                  />
                  <p className='text-xs font-semibold w-[65px] text-center'>1,522 users</p>
                </div>
                <div className='bg-white rounded-full px-2 py-1 pl-12 relative hidden lg:block ml-auto'>
                  <Image
                    src='/images/grave-drawing.png'
                    ...
                    className='absolute left-3 top-1/2 -translate-y-1/2'
                  />
                  <p className='text-sm font-semibold w-[80px] text-center'>1,522 users</p>
                </div>
              </div>
