      ...
      <div className="bg-white flex flex-col shrink-0 lg:w-[400px] xl:w-[500px] p-8 py-12 lg:p-12">
        <div className="lg:grow lg:pt-24 space-y-8 lg:space-y-10">
          ...
          <p className="text-center max-w-lg mx-auto">
            <Balancer>
              Just 3 Singaporean boys trying to make 30k MMR so they can retire
          ...
          <div className="flex items-center justify-center space-x-12">
            <Link
              href={'https://www.tiktok.com/@thejoblessclub?_t=8oeLDQhDjdm'}
            >
              <svg
                width="97"
                height="97"
            ...
            <Link
              href={'https://www.youtube.com/channel/UCd5Z9G0FitYRP9MSZb7aXXQ'}
            >
              <svg
                width="97"
                height="98"
        ...
        <div className="text-center mx-auto max-w-xs pt-12 lg:pt-">
          ...
          <p>
            ...
            <a
              className="underline font-bold text-primary"
              href="mailto:thejoblessclub@gmail.com"
            >
        ...
        <ul className="space-y-4 p-10">
          <li className="bg-secondary hover:bg-zinc-100 hover:scale-[1.01] duration-200 rounded-lg w-full p-4 lg:p-6 cursor-pointer">
            <a href="https://www.sharpknifesg.com/" target="_blank">
              <div className="flex items-center mb-2">
                ...
                />
                <h3 className="font-black text-base lg:text-3xl">
                  Knife Sharpening SG
                </h3>
                <div className="bg-white rounded-full px-1 py-1 pl-5 relative block lg:hidden ml-auto">
                  ...
                  />
                  <p className="text-xs font-semibold w-[65px] text-center">
                    <Revenue business="kss" />
                  </p>
                </div>
                <div className="bg-white rounded-full px-2 py-1 pl-12 relative hidden lg:block ml-auto">
                  ...
                  />
                  <p className="text-sm font-semibold w-[80px] text-center">
                    <Revenue business="kss" />
                  </p>
                </div>
              </div>
              <p className="text-xs lg:text-base">
                A professional pick-up knife sharpening service for chefs and
                homecooks in Singapore.
              </p>
            </a>
          </li>
          <li className="bg-secondary hover:bg-zinc-100 hover:scale-[1.01] duration-200 rounded-lg w-full p-4 lg:p-6 cursor-pointer">
            <a href="https://the100club.io/" target="_blank">
              ...
              <p className="text-xs lg:text-base">
                A private mastermind community for founders in Singapore. We run
                monthly casual events, masterminds, and coffee chats for our
                members.
              </p>
            </a>
          </li>
          <li className="bg-secondary hover:bg-zinc-100 hover:scale-[1.01] duration-200 rounded-lg w-full p-4 lg:p-6 cursor-pointer">
            <a href="https://www.tehpengclub.com/" target="_blank">
              ...
              <p className="text-xs lg:text-base">
                We help telegram communities engage members by matching them for
                1:1 chats every month - no fees.
              </p>
            </a>
          </li>
          <li className="bg-secondary hover:bg-zinc-100 hover:scale-[1.01] duration-200 rounded-lg w-full p-4 lg:p-6 cursor-pointer">
            <a href="https://t.me/sparkk_social_bot" target="_blank">
              ...
              <p className="text-xs lg:text-base">
                Spark conversation with fun prompts in your Telegram groups!
              </p>
            </a>
          </li>
          <li className="bg-secondary hover:bg-zinc-100 hover:scale-[1.01] duration-200 rounded-lg w-full p-4 lg:p-6 cursor-pointer">
            <a href="https://www.meetyourdonna.com/" target="_blank">
              ...
              <p className="text-xs lg:text-base">
                ...
                will take care of tasks that are stealing your energy, leaving
          ...
          {/*         className="hidden lg:block mr-4" */}
          {/*       /> */}
          {/*       <h3 className="font-black text-sm lg:text-3xl"> */}
          {/*         100DAY$ Challenge */}
          {/*       </h3> */}
          {/*       <div className="bg-white rounded-full px-1 py-1 pl-5 relative block lg:hidden ml-auto"> */}
          {/*         <Image */}
          ...
          {/*     </div> */}
          {/*     <p className="text-xs lg:text-base"> */}
          {/*       An accountability challenge to yourself, alongside like-minded */}
          {/*       others! Force yourself to start something new with the help of a */}
          {/*       community. */}
          {/*     </p> */}
          {/*   </a> */}
          {/* </li> */}
